...
{
    return MsgBox(msg, kTitleWarn, mb_OK, mb_IconExclamation);
}
...
void ShowBestLuckMsg(const RedPacket& packet, LPCTSTR packetLabel)
{
    ...
    else
    {
        ...
        {
            _stprintf(msg, TEXT("%s������ѣ�%hs��%hs Ԫ��"),
                packetLabel, who.c_str(), money.c_str());
        }
        else
        {
            _stprintf(msg, TEXT("%s������ѣ�%hs��"), packetLabel, best.c_str());
        }
    }
    ShowInfoBox(msg);
}
...
{
    TCHAR line[256] = { 0 };
    _stprintf(line, TEXT("��ϲ��%hs ���� %.2f Ԫ�����"), grabber.c_str(), money);
...
void ShowPacketLog(const RedPacket& packet, LPCTSTR packetLabel)
{
    ...
    for (int i = 0; i < count; ++i)
    {
        ...
        if (ParseNameMoney(pRecs[i], who, money))
        {
            ...
            {
                _stprintf(line, TEXT("%hs ������ %hs Ԫ��������ѣ�"), who.c_str(), money.c_str());
            }
            else
            {
                _stprintf(line, TEXT("%hs ������ %hs Ԫ"), who.c_str(), money.c_str());
            }
        }
        else
        {
            _stprintf(line, TEXT("%hs"), pRecs[i].c_str());
        }
        AppendLog(line);
    }
...
void DoGrabWithName(RedPacket& packet, const string& who, LPCTSTR packetLabel, bool showResultText)
{
    ...
    {
        TCHAR msg[256] = { 0 };
        _stprintf(msg, TEXT("%hs �Ѿ�����%s��ÿ���û�ֻ����һ�Ρ�"), who.c_str(), packetLabel);
        UpdateLeftFooter(packet, packetLabel);
        ShowWarnBox(msg);
        return;
    }
    ...
    // ���3���ɹ��������
    TCHAR msg[256] = { 0 };
    _stprintf(msg, TEXT("��ϲ��%hs ��%s���� %.2f Ԫ��"), who.c_str(), packetLabel, got);
    ShowInfoBox(msg);
